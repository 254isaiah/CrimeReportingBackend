...
<div class="wrapper">
    <div class="sidebar">
        <h2>Kenya Police Admin</h2>
        <ul>
            <li><a href="dashboard.php"><i class="fas fa-home"></i>Dashboard</a></li>
            <li><a href="user_list.php"><i class="fas fa-user"></i>Registered Users</a></li>
            <li><a href="missingPeople.php"><i class="fas fa-address-card"></i>Missing People</a></li>
            <li><a href="reportedComplaints.php"><i class="fas fa-file-alt"></i>Reported Complaints</a></li>
            <li><a href="#"><i class="fas fa-history"></i>Assigned Complaints</a></li>
    ...
    <div class="main_content">
      ...
      <div class="footer">
    <h1 class="copyright">  &copy; 2021 Developed By Isaiah </h1>
</div>
    </div>
