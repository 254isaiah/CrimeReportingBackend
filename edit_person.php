                            ...
                            if ($getdata > 0)
                            {
                                ...
                                <form action="code.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" name="birthCert" value="<?=$getdata['birthCertNo']; ?>" class="form-control">                            
                                    </div>
                                    <div class="form-group mb-3">
                                    ...
                                    <div class="form-floating">
                                        <textarea class="form-control" name="description" value="<?=$getdata['description']; ?>" style="height: 100px"></textarea>
                                    ...
                                    <div class="form-group mb-3">
                                        <button type="submit" name="update_person" class="btn btn-success">Update Person</button>
                                    </div>
                                </form>
